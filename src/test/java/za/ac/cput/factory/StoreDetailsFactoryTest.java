...
class StoreDetailsFactoryTest {
    ...
    @Test
    void invalidEmail(){
        StoreDetails sd = StoreDetailsFactory.buildStoreDetails("PC Warehouse","65 Church street, Cape Town","0895643684","PCWarehouseStore@");
        assertNull(sd);
    }
    ...
    void testEquality(){
        ...
        StoreDetails sd2 = StoreDetailsFactory.buildStoreDetails("PC Mark","69 Nice street, Cape Town","0655643684","PCMarkStore@gmail.com");
